Hello folks, we will be developing an article publishing platform like Medium. You have to design & build the backend for the application and the ability for the users to register, read, like and comment on the articles.
Your task is to go through below templates/stories and create the application.
